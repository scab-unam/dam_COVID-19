...
\begin{center}
    \includegraphics[width=\textwidth]{graf/tsam_COVID19_JHU_cfr+propDeathCases_ByAge_China+SKorea+Italy_OneFigure.png}
    \end{center}
\end{figure}
...
\begin{center}
    ...
    \includegraphics[width=\textwidth]{graf/tsam_COVID19_JHU_cfr+propDeathCasesByAgeTS_EstimatesMexico_subReportFactor1.png}
\end{center}
\end{figure}
